...
- **Deliverables:** `src/store/mission.store.ts` (102 lines)
- **Description:** Zustand store for active mission execution. States: `IDLE → ACTIVE → SUBMITTING → DONE → ERROR`. Stores current phase, mission object, responses (partial), and error. `reset()` action clears to IDLE.
...
- **Owner:** Claude Sonnet 4.5
- **Completed:** 2026-06-12
- **Deliverables:** `src/services/mission.service.ts` (133 lines)
- **Description:** Four functions:
  1. `fetchMissionById(id)` — fetches single mission row from Supabase
  2. `fetchTodayMission(userId, weekNum, dayNum)` — deterministic mission selection
  3. `checkTodayCompletion(userId, today)` — checks if already completed
  4. `completeMission(payload)` — calls `supabase.rpc('complete_mission', {...})`, handles `already_completed` response gracefully
- **Done when:** All functions return typed `AsyncResult<T>`, handle errors without throwing
...
- **Owner:** Claude Sonnet 4.5
- **Completed:** 2026-06-12
- **Deliverables:** `src/hooks/useMissionEngine.ts` (117 lines)
...
- **Owner:** Claude Sonnet 4.5
- **Completed:** 2026-06-12
- **Deliverables:** `src/components/mission-types/ReflectWrite.tsx` (252 lines)
- **Description:**
...
- **Owner:** Claude Sonnet 4.5
- **Completed:** 2026-06-12
- **Deliverables:** `src/components/mission-types/PollReasoning.tsx` (341 lines)
- **Description:**
...
- **Owner:** Claude Sonnet 4.5
- **Completed:** 2026-06-12
- **Deliverables:** `src/components/mission-types/DailyChallenge.tsx` (280 lines)
- **Description:**
...
- **Owner:** Claude Sonnet 4.5
- **Completed:** 2026-06-12
- **Deliverables:** `app/mission/[id].tsx` (366 lines)
- **Description:**
...
- **Owner:** Claude Sonnet 4.5
- **Completed:** 2026-06-12
- **Deliverables:** `app/mission/success.tsx` (285 lines)
- **Description:**
